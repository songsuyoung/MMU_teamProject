...
public class StageTwo extends GameObject {
	...
	public StageTwo() {
		...
		reddia=new ImageIcon("images/reddia.png");
		Rdia=reddia.getImage();
		bluedia=new ImageIcon("images/bluedia.png");
		Bdia=bluedia.getImage();


		block.add(new BlockObject(240,600,40*2,40*3)); //0
		block.add(new BlockObject(160,280,40*3,40*1)); //1
		block.add(new BlockObject(120,240,40,40*8)); //2
		block.add(new BlockObject(120,560,40*5,40*2)); //3
		block.add(new BlockObject(240,680,40*4,40));//4
		block.add(new BlockObject(640,680,40*8,40));//5
		block.add(new BlockObject(120,115,40*4,40));//6
		block.add(new BlockObject(520,280,40*3,40));//7
		block.add(new BlockObject(360,360,40*5,40));//8
		block.add(new BlockObject(480,180,40,40));//9
		block.add(new BlockObject(380,160,40,40));//10
		block.add(new BlockObject(720,160,40,40));//11
		block.add(new BlockObject(680,120,40,40*9));	//12	
		block.add(new BlockObject(680,480,40*4,40));//13
		block.add(new BlockObject(920,560,40,40*4));//14
		block.add(new BlockObject(800,600,40,40*3));//15
		block.add(new BlockObject(760,640,40,40*2));//16
		block.add(new BlockObject(800,600,40,40*3));//1
		block.add(new BlockObject(800,240,40*4,40));
		block.add(new BlockObject(810,360,40*2,40)); //실제론 x:840,360
		block.add(new BlockObject(800,280,40,40*3));
		block.add(new BlockObject(900,520,60,10)); // 올라갈곳
		...
		block.add(new BlockObject(680,480,0,0));
		...
		block.add(new BlockObject(50,700,60,10));

		block.add(new BlockObject(720,380,0,0)); // 맨 아래 가로
		
		block.add(new BlockObject(760,300,0,0));
